...
function RevealObjective1()
	...
	StartThread(Reinforcements_Objective1_infantry);
end;
...
-- if supply truck destroyed
function Reinforcements_Objective1_infantry()
	while 1 do 
	Wait(1);
			if (GetNUnitsInScriptGroup(1122, 1) < 1) then
			LandReinforcementFromMap(1, "infantry", 2, 1103);
			Wait(1);
			Cmd(ACT_SWARM, 1103, 1000, 1045, 6235);
		break;
		end;
	end;
end;
...
Trigger(Objective0_2, CompleteObjective0_2);