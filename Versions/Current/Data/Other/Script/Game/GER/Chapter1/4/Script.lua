...
function Zasada()
	while 1 do
		...
		if (GetNUnitsInArea ( 0 , "Zasada" , 0 ) > 0) then
			LandReinforcementFromMap ( 1 , "0" , 0 , 999 );
			Cmd (3 , 999 , 0 , GetScriptAreaParams "Zasada");
			Wait( 3 );
...
function Go()
	...
	Cmd (3 , 204 , 0 , GetScriptAreaParams "Go41");
...
function Move()
	...
	Cmd (3 , 204 , 0 , GetScriptAreaParams "Go42");
	QCmd (3 , 204 , 0 , GetScriptAreaParams "Go43");
	QCmd (3 , 204 , 0 , GetScriptAreaParams "Town");
...
function Attake3()
	while 1 do
		...
		if (GetNUnitsInScriptGroup ( 203 ) < 1) then
			LandReinforcementFromMap ( 2 , "1" , 0 , 203 );
			Wait ( 3 );
			Cmd (3 , 203 , 0 , GetScriptAreaParams "Go31");
...
function Attake4()
	while 1 do
		Wait( 3 );
		if (GetNUnitsInScriptGroup ( 204 ) < 1) then
			LandReinforcementFromMap ( 2 , "3" , 0 , 204 );
			Wait ( 3 );
			Cmd (3 , 204 , 0 , GetScriptAreaParams "Go41");
			QCmd (3 , 204 , 0 , GetScriptAreaParams "Go42");
			QCmd (3 , 204 , 0 , GetScriptAreaParams "Go43");
			QCmd (3 , 204 , 0 , GetScriptAreaParams "Town");
			StartThread( Stop4 );
			break;
...
function Attake5()
	while 1 do
		...
		if (GetNUnitsInScriptGroup ( 205 ) < 1) then
			LandReinforcementFromMap ( 2 , "2" , 0 , 205 );
			Wait ( 3 );
			Cmd (3 , 205 , 0 , GetScriptAreaParams "Go51");
...
function CompleteObjective0()
	while 1 do
		Wait( 3 );
		if (GetNUnitsInArea ( 0 , "Town" , 0 ) > 0) or (GetNUnitsInArea ( 2 , "Town" , 0 ) > 0) then
