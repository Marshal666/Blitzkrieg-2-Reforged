...
function Allies_Attack2()
	LandReinforcement( 3, 1013, 0, 4001 ); 
	Wait( 2 );
	Cmd( 3, 4001, 50, 3788, 4010 );
	QCmd( 3, 4001, 50, 5171, 5972 );
	LandReinforcement( 3, 1014, 0, 4002 ); 
	Wait( 2 );
	Cmd( 3, 4002, 50, 4773, 5077 );
	LandReinforcement( 3, 1013, 0, 4003 ); 
	Wait( 6 );
...
function T1()
	...
	LandReinforcement( 2, 1011, 0, 301 ); 
	Wait( 2 );
...
function T2()
	Wait( 30 + RandomInt( 120 ) );
	LandReinforcement( 2, 1011, 1, 302 ); 
	Wait( 2 );
...
function T3()
	Wait( 30 + RandomInt( 120 ) );
	LandReinforcement( 2, 1011, 2, 303 ); 
	Wait( 2 );
...
function I1()
	Wait( 40 + RandomInt( 150 ) );
	LandReinforcement( 2, 1012, 0, 311 ); 
	Wait( 2 );
...
function I2()
	Wait( 40 + RandomInt( 150 ) );
	LandReinforcement( 2, 1012, 1, 312 ); 
	Wait( 2 );
