...
function AttackCoastGuns ()
	...
	Wait(4);
	LandReinforcementFromMap (ID_GERMANS, "GermanTroopers", 1, ID_GERMAN_TROOPERS2+2);
	Cmd (ACT_UNLOAD, ID_GERMAN_TROOPERS2+2, 50, GetScriptAreaParams ("WLandingZone2"));
	if (GetDifficultyLevel() == 2) then
		Wait(7);
		LandReinforcementFromMap (ID_GERMANS, "GermanTroopers", 1, ID_GERMAN_TROOPERS2+4);
		Cmd (ACT_UNLOAD, ID_GERMAN_TROOPERS2+4, 50, GetScriptAreaParams ("WLandingZone3"));
	end;
	--Wait(4);
