...
function EasyMode()
	guns = GetUnitsByParamScriptId( 5011, PT_CLASS, CLASS_ANTITANK_GUN );
	RemoveArray( guns );
	guns = GetUnitsByParamScriptId( 5010, PT_CLASS, CLASS_ANTITANK_GUN );
	RemoveArray( guns );
	guns = GetUnitsByParamScriptId( 5000, PT_CLASS, CLASS_ANTITANK_GUN );
	RemoveArray( guns );
	guns = GetUnitsByParamScriptId( 5001, PT_CLASS, CLASS_ANTITANK_GUN );
	RemoveArray( guns );
end;
