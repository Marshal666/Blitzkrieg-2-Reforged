...
function Karlos()
	while 1 do
		...
		if ( GetNUnitsInScriptGroup( 9991 ) < 1 ) then
			GiveObjective( 4 );
			Wait( 1 );
			CompleteObjective( 4 );
			break;
