...
function Allies ()
     Wait (450)
    if (GetNUnitsInPlayerUF (2) > 1) then 
     Wait (3)
     CompleteObjective(1)
     Wait (3)
     LandReinforcementFromMap (2, "GAP", 0, 100100);
     Cmd (3, 100100, 100, 4598, 5102);
     Wait (15)
     LandReinforcementFromMap (2, "GAP", 0, 100101);
     Cmd (3, 100101, 100, 4598, 5102);
    end;
end;
