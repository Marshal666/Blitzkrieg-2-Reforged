...
function B1 ()
    while 1 do
     Wait (1)   
        if (GetScriptObjectHPs (101) < 100000) then 
         DamageScriptObject (101, -100000);
        end;
    end;
end;
...
function B2 ()
    while 1 do
     Wait (1)   
        if (GetScriptObjectHPs (102) < 100000) then 
         DamageScriptObject (102, -100000);
        end;
    end;
end;
...
function B3 ()
    while 1 do
     Wait (1)   
        if (GetScriptObjectHPs (103) < 100000) then 
         DamageScriptObject (103, -100000);
        end;
    end;
end;  
------------------------------------------------
...
function Fighters3 ()
    while 1 do
     Wait (5)
     if Objective1 == 1 and (GetNUnitsInScriptGroup (678) < 1) and f <2 then
         Wait (5)
