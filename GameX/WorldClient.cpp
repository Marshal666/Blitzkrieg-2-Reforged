...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const int CLIENT_UNIQUE_ID_MAP_COMMAND_ACK = -2; // look for other CLIENT_UNIQUE_ID_xxx (�����, �� ������ ������)
const int CLIENT_UNIQUE_ID_MAP_COMMAND_ACK_DIR = -3; // look for other CLIENT_UNIQUE_ID_xxx (�����, �� ������ ������)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	pSelector->DoUpdateSpecialAbility( pMO ); // �������� �������v� ������� ����� ������ ����� ��������
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CWorldClient::DoUpdateObjectStats( CMapObj *pMO )
{
	pSelector->DoUpdateStats( pMO ); // �������� ����v ������� ����� ������ ����� ��������
