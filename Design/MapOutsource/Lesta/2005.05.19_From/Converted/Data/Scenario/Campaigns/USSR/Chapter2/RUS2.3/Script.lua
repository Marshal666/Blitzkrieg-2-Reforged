...
function Start_Atack_Avia_and_Art()
	...
	LandReinforcementFromMap(1,"Bomber",1, 300);	
	Wait(2);
...
function Last_Atak_Tank_1()
	...
	QCmd(3, 2000, 20, GetScriptAreaParams("Shturmovka"));
	
	LandReinforcementFromMap(1,"tank_dead",1, 2100);
	Cmd(3, 2100, 20, GetScriptAreaParams("move_3"));
	QCmd(3, 2100, 20, GetScriptAreaParams("Shturmovka"));
...
function Last_Atak_Tank_2()
	...
	QCmd(3, 2600, 20, GetScriptAreaParams("Shturmovka"));
	
	LandReinforcementFromMap(1,"samohodki",1, 2650);
	Cmd(3, 2650, 20, GetScriptAreaParams("move_3"));
	QCmd(3, 2650, 20, GetScriptAreaParams("Shturmovka"));
...
function Last_Atak_Pehota_2()
	...
	QCmd(3, 2850, 20, GetScriptAreaParams("Shturmovka"));
	...
	--QCmd(3, 2900, 20, GetScriptAreaParams("Shturmovka"));
	...
	QCmd(3, 2950, 20, GetScriptAreaParams("Shturmovka"));
