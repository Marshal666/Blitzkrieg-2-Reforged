...
function battery_move()
	...
	Cmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_1"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_2"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_3"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_4"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_5"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_6"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_7"));
	QCmd(ACT_MOVE, First_moto, 15, GetScriptAreaParams("move_8"));
	QCmd(ACT_MOVE, First_moto, 20, GetScriptAreaParams("moto_parking"));
	
	--2
	Wait(1);
	
	Cmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_1"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_2"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_3"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_4"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_5"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_6"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_7"));
	QCmd(ACT_MOVE, Second_moto, 15, GetScriptAreaParams("move_8"));
	QCmd(ACT_MOVE, Second_moto, 20, GetScriptAreaParams("moto_parking"));
	--3
	Wait(1);
	...
	Cmd(ACT_MOVE, Machinery_1, 15, GetScriptAreaParams("move_1"));
	QCmd(ACT_MOVE, Machinery_1, 15, GetScriptAreaParams("move_2"));
	QCmd(ACT_MOVE, Machinery_1, 15, GetScriptAreaParams("move_3"));
	QCmd(ACT_MOVE, Machinery_1, 15, GetScriptAreaParams("move_4"));
